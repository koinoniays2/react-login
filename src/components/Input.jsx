...
export default function Input({label, type, name, placeholder, register, option, errors}) {
    const inputCSS = "w-full border-b border-gray-500 py-1";
    return (
        <div className="w-full pb-5">
            ...
            {register ? (
                <>  
                <input type={type} id={name} placeholder={placeholder} className={inputCSS} 
                {...register(name, option)} readOnly={name === "address"}/>
